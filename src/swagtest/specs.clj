...
(s/fdef swagtest.parse/construct-base-url
        :args (s/cat :config string?))
;; (stest/instrument 'swagtest.parse/construct-base-url)
;; (s/exercise-fn `swagtest.parse/trim-and-normalize)
;; (stest/abbrev-result (first (stest/check `swagtest.parse/trim-and-normalize)))
